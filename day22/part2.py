...
bricks = [(i, bricks[i]) for i in range(len(bricks))]
...
def fall_bricks(bricks):
    ...
    for i, brick in bricks:
        ...
        while brick[0][2] != 1:
            ...
            for j, fallen_brick in fallen_bricks:
...
for i in range(len(bricks)):
    ...
    fallen_test_bricks = fall_bricks(test_bricks)
    comp1 = {i:brick for i, brick in test_bricks}
    comp2 = {i:brick for i, brick in fallen_test_bricks}
    # Find how many bricks change
    for i in comp1:
        if comp1[i] != comp2[i]:
            total += 1
print(total)
